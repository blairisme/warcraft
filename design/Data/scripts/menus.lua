...
--
--      $Id: menus.lua 1321 2005-11-16 01:35:51Z jsalmon3 $
...
DefineMenu("name", "menu-victory", "geometry", {256, 176, 288, 128},
  "panel", "panel4", "default", 2, "init", "victory-init")
...
DefineMenu("name", "menu-defeated", "geometry", {256, 176, 288, 128},
  "panel", "panel4", "default", 2, "init", "defeated-init")
DefineMenuItem("pos", { 144, 11}, "font", "large",
...
DefineMenu("name", "menu-save-replay", "geometry", {256, 176, 288, 128},
  "panel", "panel4", "default", 1, "init", "save-replay-init", "exit", "save-replay-exit")
DefineMenuItem("pos", { 144, 11}, "font", "large",
...
DefineMenu("name", "menu-global-options", "geometry", {144, 64, 352, 352},
  "panel", "panel5", "background", MenuBackground, "default", 8, "init", "global-options-init", "exit", "global-options-exit")
...
DefineMenu("name", "menu-multi-setup", "geometry", {0, 0, 640, 480},
  "panel", "none", "background", MenuBackground, "default", 3, "init", "multi-game-setup-init", "exit", "multi-game-setup-exit")
DefineMenuItem("pos", { 0, 0}, "font", "game",
...
DefineMenuItem("pos", { (640 / 2) + 12, 8}, "font", "large",
  ...
  "menu", "menu-multi-setup")
DefineMenuItem("pos", { 16, 360 + (36 * 2)}, "font", "large",
  "button", {
    "caption", "S~!elect Scenario",
    "hotkey", "e",
...
DefineMenuItem("pos", { 40, 32 + (22 * 7)}, "font", "game",
  "pulldown",  {"size", {172, 20},
    ...
    "current", 0},
  "menu", "menu-multi-setup")
DefineMenuItem("pos", { 40, 32 + (22 * 8)}, "font", "game",
  "pulldown",  {"size", {172, 20},
    "style", "pulldown",
    "func", "multi-game-pts-action",
    "options", {"Available", "Computer", "Closed" },
    ...
    "current", 0},
  "menu", "menu-multi-setup")
DefineMenuItem("pos", { 40, 32 + (22 * 9)}, "font", "game",
  "pulldown",  {"size", {172, 20},
    "style", "pulldown",
    "func", "multi-game-pts-action",
    "options", {"Available", "Computer", "Closed" },
    ...
    "current", 0},
  "menu", "menu-multi-setup")
DefineMenuItem("pos", { 40, 32 + (22 * 10)}, "font", "game",
  "pulldown",  {"size", {172, 20},
    "style", "pulldown",
    "func", "multi-game-pts-action",
    "options", {"Available", "Computer", "Closed" },
    ...
    "current", 0},
  "menu", "menu-multi-setup")
DefineMenuItem("pos", { 40, 32 + (22 * 11)}, "font", "game",
  "pulldown",  {"size", {172, 20},
    "style", "pulldown",
    "func", "multi-game-pts-action",
    "options", {"Available", "Computer", "Closed" },
    ...
    "current", 0},
  "menu", "menu-multi-setup")
DefineMenuItem("pos", { 40, 32 + (22 * 12)}, "font", "game",
  "pulldown",  {"size", {172, 20},
    "style", "pulldown",
    "func", "multi-game-pts-action",
    "options", {"Available", "Computer", "Closed" },
    ...
    "current", 0},
  "menu", "menu-multi-setup")
DefineMenuItem("pos", { 40, 32 + (22 * 13)}, "font", "game",
  "pulldown",  {"size", {172, 20},
    "style", "pulldown",
    "func", "multi-game-pts-action",
    "options", {"Available", "Computer", "Closed" },
    ...
    "current", 0},
  "menu", "menu-multi-setup")
DefineMenuItem("pos", { 40, 32 + (22 * 14)}, "font", "game",
  "pulldown",  {"size", {172, 20},
    "style", "pulldown",
    "func", "multi-game-pts-action",
    "options", {"Available", "Computer", "Closed" },
    ...
    "current", 0},
  "menu", "menu-multi-setup")
DefineMenuItem("pos", { 280, 32}, "font", "game",
  "text", {"caption", "~<Your Race:~>"},
  "menu", "menu-multi-setup")
DefineMenuItem("pos", { 280, 32 + 20}, "font", "game",
  "pulldown",  {"size", {152, 20},
    "style", "pulldown",
    "func", "game-rcs-action"},
  "menu", "menu-multi-setup")
DefineMenuItem("pos", { 460, 32}, "font", "game",
  "text", {"caption", "~<Resources:~>"},
  "menu", "menu-multi-setup")
DefineMenuItem("pos", { 460, 32 + 20}, "font", "game",
  "pulldown",  {"size", {152, 20},
    "style", "pulldown",
    "func", "game-res-action",
    "options", {"Map Default", "Low", "Medium", "High" },
    ...
    "current", 0},
  "menu", "menu-multi-setup")
DefineMenuItem("pos", { 280, 32 + 44}, "font", "game",
  "text", {"caption", "~<Units:~>"},
  "menu", "menu-multi-setup")
DefineMenuItem("pos", { 280, 32 + 44 + 20}, "font", "game",
  "pulldown",  {"size", {152, 20},
    "style", "pulldown",
    "func", "game-uns-action",
    "options", {"Map Default", "One Peasant Only" },
    ...
    "current", 0},
  "menu", "menu-multi-setup")
DefineMenuItem("pos", { 460, 32 + 44}, "font", "game",
  "text", {"caption", "~<Fog of War:~>"},
  "menu", "menu-multi-setup")
DefineMenuItem("pos", { 460, 32 + 44 + 20}, "font", "game",
  "pulldown",  {"size", {152, 20},
    "style", "pulldown",
    ...
    "current", 0},
  "menu", "menu-multi-setup")
DefineMenuItem("pos", { 280, 32 + 44 * 2}, "font", "game",
  "text", {"caption", "~<Map Tileset:~>"},
  "menu", "menu-multi-setup")
DefineMenuItem("pos", { 280, 32 + 44 * 2 + 20}, "font", "game",
  "pulldown",  {"size", {152, 20},
    "style", "pulldown",
    "func", "game-tss-action"},
  "menu", "menu-multi-setup")
DefineMenuItem("pos", { 460, 32 + 44 * 2}, "font", "game",
  "text", {"caption", "~<Game Type:~>"},
  "menu", "menu-multi-setup")
DefineMenuItem("pos", { 460, 32 + 44 * 2 + 20}, "font", "game",
  "pulldown",  {"size", {152, 20},
    "style", "pulldown",
    "func", "game-gat-action",
    "options", {"Use map settings", "Melee", "Free for all", "Top vs bottom", "Left vs right", "Man vs Machine" },
...
DefineMenuItem("pos", { 10, 32 + (22 * 7)}, "font", "large",
  "checkbox", {
    ...
    "style", "square"},
  "menu", "menu-multi-setup")
DefineMenuItem("pos", { 10, 32 + (22 * 8)}, "font", "large",
  "checkbox", {
    "state", "passive",
    "func", nil,
    "style", "square"},
  "menu", "menu-multi-setup")
DefineMenuItem("pos", { 10, 32 + (22 * 9)}, "font", "large",
  "checkbox", {
    "state", "passive",
    "func", nil,
    "style", "square"},
  "menu", "menu-multi-setup")
DefineMenuItem("pos", { 10, 32 + (22 * 10)}, "font", "large",
  "checkbox", {
    "state", "passive",
    "func", nil,
    "style", "square"},
  "menu", "menu-multi-setup")
DefineMenuItem("pos", { 10, 32 + (22 * 11)}, "font", "large",
  "checkbox", {
    "state", "passive",
    "func", nil,
    "style", "square"},
  "menu", "menu-multi-setup")
DefineMenuItem("pos", { 10, 32 + (22 * 12)}, "font", "large",
  "checkbox", {
    "state", "passive",
    "func", nil,
    "style", "square"},
  "menu", "menu-multi-setup")
DefineMenuItem("pos", { 10, 32 + (22 * 13)}, "font", "large",
  "checkbox", {
    "state", "passive",
    "func", nil,
    "style", "square"},
  "menu", "menu-multi-setup")
DefineMenuItem("pos", { 10, 32 + (22 * 14)}, "font", "large",
  "checkbox", {
    "state", "passive",
    "func", nil,
    "style", "square"},
...
DefineMenuItem("pos", { 218, 32 + (22 * 7)}, "font", "large",
  "checkbox", {
    ...
    "style", "round"},
  "menu", "menu-multi-setup")
DefineMenuItem("pos", { 218, 32 + (22 * 8)}, "font", "large",
  "checkbox", {
    "state", "passive",
    "func", nil,
    "style", "round"},
  "menu", "menu-multi-setup")
DefineMenuItem("pos", { 218, 32 + (22 * 9)}, "font", "large",
  "checkbox", {
    "state", "passive",
    "func", nil,
    "style", "round"},
  "menu", "menu-multi-setup")
DefineMenuItem("pos", { 218, 32 + (22 * 10)}, "font", "large",
  "checkbox", {
    "state", "passive",
    "func", nil,
    "style", "round"},
  "menu", "menu-multi-setup")
DefineMenuItem("pos", { 218, 32 + (22 * 11)}, "font", "large",
  "checkbox", {
    "state", "passive",
    "func", nil,
    "style", "round"},
  "menu", "menu-multi-setup")
DefineMenuItem("pos", { 218, 32 + (22 * 12)}, "font", "large",
  "checkbox", {
    "state", "passive",
    "func", nil,
    "style", "round"},
  "menu", "menu-multi-setup")
DefineMenuItem("pos", { 218, 32 + (22 * 13)}, "font", "large",
  "checkbox", {
    "state", "passive",
    "func", nil,
    "style", "round"},
  "menu", "menu-multi-setup")
DefineMenuItem("pos", { 218, 32 + (22 * 14)}, "font", "large",
  "checkbox", {
    "state", "passive",
    "func", nil,
    "style", "round"},
  "menu", "menu-multi-setup")
DefineMenuItem("pos", { 40, 34 + (22 * 0)}, "font", "large",
  "drawfunc", "net-multi-player-draw-func",
  "menu", "menu-multi-setup")
DefineMenuItem("pos", { 40, 34 + (22 * 1)}, "font", "large",
  "drawfunc", "net-multi-player-draw-func",
  "menu", "menu-multi-setup")
DefineMenuItem("pos", { 40, 34 + (22 * 2)}, "font", "large",
  "drawfunc", "net-multi-player-draw-func",
  "menu", "menu-multi-setup")
DefineMenuItem("pos", { 40, 34 + (22 * 3)}, "font", "large",
  "drawfunc", "net-multi-player-draw-func",
  "menu", "menu-multi-setup")
DefineMenuItem("pos", { 40, 34 + (22 * 4)}, "font", "large",
  "drawfunc", "net-multi-player-draw-func",
  "menu", "menu-multi-setup")
DefineMenuItem("pos", { 40, 34 + (22 * 5)}, "font", "large",
  "drawfunc", "net-multi-player-draw-func",
  "menu", "menu-multi-setup")
DefineMenuItem("pos", { 40, 34 + (22 * 6)}, "font", "large",
  "drawfunc", "net-multi-player-draw-func",
  "menu", "menu-multi-setup")
DefineMenuItem("pos", { 40, 34 + (22 * 7)}, "font", "large",
  "drawfunc", "net-multi-player-draw-func",
  "menu", "menu-multi-setup")
DefineMenuItem("pos", { 40, 34 + (22 * 8)}, "font", "large",
  "drawfunc", "net-multi-player-draw-func",
  "menu", "menu-multi-setup")
DefineMenuItem("pos", { 40, 34 + (22 * 9)}, "font", "large",
  "drawfunc", "net-multi-player-draw-func",
  "menu", "menu-multi-setup")
DefineMenuItem("pos", { 40, 34 + (22 * 10)}, "font", "large",
  "drawfunc", "net-multi-player-draw-func",
  "menu", "menu-multi-setup")
DefineMenuItem("pos", { 40, 34 + (22 * 11)}, "font", "large",
  "drawfunc", "net-multi-player-draw-func",
  "menu", "menu-multi-setup")
DefineMenuItem("pos", { 40, 34 + (22 * 12)}, "font", "large",
  "drawfunc", "net-multi-player-draw-func",
  "menu", "menu-multi-setup")
DefineMenuItem("pos", { 40, 34 + (22 * 13)}, "font", "large",
  "drawfunc", "net-multi-player-draw-func",
  "menu", "menu-multi-setup")
DefineMenuItem("pos", { 40, 34 + (22 * 14)}, "font", "large",
  "drawfunc", "net-multi-player-draw-func",
  "menu", "menu-multi-setup")
...
DefineMenuItem("pos", { 640 - 224 - 16, 360 + (36 * 1)}, "font", "large",
  "button", {
    ...
    "style", "gm-half"},
  "menu", "menu-net-multi-client")
DefineMenuItem("pos", { 640 - 106 - 16, 360 + (36 * 1)}, "font", "large",
  "button", {
    "caption", "~!Not Ready",
    "hotkey", "n",
...
DefineMenu("name", "menu-sound-options", "geometry", {224, 64, 352, 352},
  "panel", "panel5", "default", 23, "init", "sound-options-init", "exit", "sound-options-exit")
DefineMenuItem("pos", { 176, 11}, "font", "large",
...
DefineMenu("name", "menu-preferences", "geometry", {272, 96, 256, 288},
  "panel", "panel1", "default", 5, "init", "preferences-init", "exit", "preferences-exit")
DefineMenuItem("pos", { 128, 11}, "font", "large",
...
DefineMenu("name", "menu-diplomacy", "geometry", {222, 76, 352, 352},
  "panel", "panel5", "default", 5, "init", "diplomacy-init", "exit", "diplomacy-exit")
...
DefineMenu("name", "menu-speed-options", "geometry", {272, 96, 256, 288},
  "panel", "panel1", "default", 13, "init", "speed-options-init", "exit", "speed-options-exit")
DefineMenuItem("pos", { 128, 11}, "font", "large",
...
DefineMenu("name", "menu-tips", "geometry", {256, 112, 288, 256},
  "panel", "panel2", "default", 4, "init", "tips-init", "exit", "tips-exit")
DefineMenuItem("pos", { 144, 11}, "font", "large",
...
DefineMenuItem("pos", { 14, 35 + (16 * i)}, "font", "game",
  "text", {"caption", Line(1 + i, GameInfo("Tips"), 260, "game")},
  "menu", "menu-tips")
end
...
DefineMenu("name", "menu-save-game", "geometry", {208, 112, 384, 256},
  "panel", "panel3", "default", 6, "init", "save-game-init", "exit", "save-game-exit")
...
DefineMenu("name", "menu-save-confirm", "geometry", {256, 112, 288, 128},
  "panel", "panel4", "default", 1, "init", "save-confirm-init", "exit", "save-confirm-exit")
...
DefineMenu("name", "menu-delete-confirm", "geometry", {256, 112, 288, 128},
  "panel", "panel4", "default", 1, "init", "delete-confirm-init", "exit", "delete-confirm-exit")
DefineMenuItem("pos", { 288 / 2, 11}, "font", "large",
...
DefineMenu("name", "menu-editor-main-load-map", "geometry", {144, 64, 352, 352},
  "panel", "panel5", "background", MenuBackground, "default", 4,
  "init", "editor-main-load-init", "exit", "editor-main-load-exit")
DefineMenuItem("pos", { 352 / 2, 11}, "font", "large",
  "text", {"caption", "Select map", "align", "center"},
...
DefineMenu("name", "menu-editor-load", "geometry", {224, 64, 352, 352},
  ...
  "init", "editor-load-init", "exit", "editor-load-exit")
DefineMenuItem("pos", { 352 / 2, 11}, "font", "large",
  "text", {"caption", "Select map", "align", "center"},
...
DefineMenu("name", "menu-editor-save-confirm", "geometry", {256, 112, 288, 128},
  "panel", "panel4", "default", 1, "init", "editor-save-confirm-init")
DefineMenuItem("pos", { 288 / 2, 11}, "font", "large",
  "text", {"caption", "Overwrite File", "align", "center"},
...
DefineMenu("name", "metaserver-list", "geometry", {0, 0, 640, 480},
  "panel", "none", "default", 3, "init", "metaserver-list-init", "exit", "metaserver-list-exit")
DefineMenuItem("pos", { 0, 0}, "font", "game",
