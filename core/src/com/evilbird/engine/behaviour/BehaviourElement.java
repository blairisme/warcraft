 ...
 */
public interface BehaviourElement
{
    /**
     * Provides the behaviour the opportunity to apply itself to the game
     * state. The behaviour is also provided with any user input that occurred
     * between this and the previous call to apply.
     *
     ...
     *              last call to update.
     */
    void apply(State state, List<UserInput> input, float time);
}
