...
public class CombatantTitlePane extends Grid implements DetailsPaneElement
{
    ...
    private com.evilbird.warcraft.item.display.control.common.UnitPane addIcon(Skin skin) {
        com.evilbird.warcraft.item.display.control.common.UnitPane unitPane = new UnitPane(skin);
