...
package com.evilbird.warcraft.item.display.control.actions;
...
public class ActionButton extends Table
{
    ...
    private com.evilbird.warcraft.item.display.control.actions.ActionButtonStyle getActionStyle() {
        com.evilbird.warcraft.item.display.control.actions.ActionButtonStyle style = getSkin().get("action-button", com.evilbird.warcraft.item.display.control.actions.ActionButtonStyle.class);
        return style != null ? style : new com.evilbird.warcraft.item.display.control.actions.ActionButtonStyle();
    }

    private ImageButtonStyle getIconStyle(ActionButtonType button) {
        com.evilbird.warcraft.item.display.control.actions.ActionButtonStyle actionStyle = getActionStyle();
