...
import com.evilbird.warcraft.item.display.control.actions.buttons.ButtonControllers;
...
public class ActionPane extends Grid implements MenuProvider
{
    ...
    public ActionPane(Skin skin) {
        ...
        setCellWidth(54);
        setCellHeight(46);
        setIdentifier(com.evilbird.warcraft.item.display.HudControl.ActionPane);
