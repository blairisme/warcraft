...
{
    private com.evilbird.warcraft.item.display.control.status.details.building.ConstructionDetailsPane constructionDetails;
    private com.evilbird.warcraft.item.display.control.status.details.building.ProductionDetailsPane productionDetails;
    private com.evilbird.warcraft.item.display.control.status.details.building.CommandCentreDetailsPane commandCentreDetails;
    private com.evilbird.warcraft.item.display.control.status.details.building.FoodProducerDetailsPane foodProducerDetails;
