...
public abstract class BasicButtonController implements ButtonController
{
    ...
    protected void addUpgradeButton(
        Player player,
        List<com.evilbird.warcraft.item.display.control.actions.ActionButtonType> buttons,
        com.evilbird.warcraft.item.display.control.actions.ActionButtonType button,
        Upgrade upgrade)
    {
