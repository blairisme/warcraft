...
public class ProductionDetailsPane extends Grid
{
    ...
    public void setSkin(Skin skin) {
        super.setSkin(skin);
        this.style = skin.get(com.evilbird.warcraft.item.display.control.status.details.DetailsPaneStyle.class);
    }
    ...
    private void addProductImage(Skin skin, Grid container) {
        com.evilbird.warcraft.item.display.control.status.details.DetailsPaneStyle style = skin.get(com.evilbird.warcraft.item.display.control.status.details.DetailsPaneStyle.class);
    ...
    private Drawable getProductIcon(ProduceUnitActions action) {
        com.evilbird.warcraft.item.display.control.status.details.DetailsPaneStyle style = getSkin().get(com.evilbird.warcraft.item.display.control.status.details.DetailsPaneStyle.class);
        return style.icons.get(action.getProduct());
    }

    private Drawable getProductIcon(ProduceUpgradeActions action) {
        com.evilbird.warcraft.item.display.control.status.details.DetailsPaneStyle style = getSkin().get(DetailsPaneStyle.class);
