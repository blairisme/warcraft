...
import com.evilbird.warcraft.item.display.control.actions.ActionButtonStyle;
import com.evilbird.warcraft.item.display.control.common.HealthBarStyle;
import com.evilbird.warcraft.item.display.control.common.UnitPaneStyle;
import com.evilbird.warcraft.item.display.control.status.details.DetailsPaneStyle;
import com.evilbird.warcraft.item.display.control.status.selection.SelectionButtonStyle;
...
public class ControlPaneBuilder
{
    ...
    private com.evilbird.warcraft.item.display.control.status.details.DetailsPaneStyle getDetailsPaneStyle() {
        com.evilbird.warcraft.item.display.control.status.details.DetailsPaneStyle style = new DetailsPaneStyle();
    ...
    private com.evilbird.warcraft.item.display.control.common.HealthBarStyle getHealthBarStyle() {
        com.evilbird.warcraft.item.display.control.common.HealthBarStyle style = new HealthBarStyle();
    ...
    private com.evilbird.warcraft.item.display.control.actions.ActionButtonStyle getActionButtonStyle() {
        com.evilbird.warcraft.item.display.control.actions.ActionButtonStyle style = new ActionButtonStyle();
        style.icons = assets.getIcons();
    ...
    private com.evilbird.warcraft.item.display.control.common.UnitPaneStyle getUnitPaneStyle() {
        com.evilbird.warcraft.item.display.control.common.UnitPaneStyle style = new UnitPaneStyle();
        style.icons = assets.getIcons();
