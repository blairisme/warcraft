...
{
    private static final List<com.evilbird.warcraft.item.display.control.actions.ActionButtonType> BUTTONS = singletonList(com.evilbird.warcraft.item.display.control.actions.ActionButtonType.GnomishFlyingMachineButton);
