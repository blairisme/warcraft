...
import com.evilbird.warcraft.item.display.control.actions.buttons.human.LumberMillButtons;
import com.evilbird.warcraft.item.display.control.actions.buttons.human.MageButtons;
import com.evilbird.warcraft.item.display.control.actions.buttons.human.OilTankerBuildings;
import com.evilbird.warcraft.item.display.control.actions.buttons.human.PaladinButtons;
import com.evilbird.warcraft.item.display.control.actions.buttons.human.PeasantAdvancedBuildings;
import com.evilbird.warcraft.item.display.control.actions.buttons.human.PeasantSimpleBuildings;
...
import com.evilbird.warcraft.item.display.control.actions.buttons.human.CastleButtons;
import com.evilbird.warcraft.item.display.control.actions.buttons.human.ChurchButtons;
import com.evilbird.warcraft.item.display.control.actions.buttons.human.GnomishInventorButtons;
import com.evilbird.warcraft.item.display.control.actions.buttons.human.GryphonAviaryButtons;
import com.evilbird.warcraft.item.display.control.actions.buttons.human.KeepButtons;
import com.evilbird.warcraft.item.display.control.actions.buttons.human.MageTowerButtons;
...
import static com.evilbird.warcraft.item.display.control.actions.ActionPaneView.Actions;
import static com.evilbird.warcraft.item.display.control.actions.ActionPaneView.AdvancedBuildings;
import static com.evilbird.warcraft.item.display.control.actions.ActionPaneView.SimpleBuildings;
