 ...
 */
public class FerryFactory implements AssetProvider<Item>
{
    private static final GridPoint2 ICON = new GridPoint2(46, 152);
    ...
    public FerryFactory(AssetManager manager) {
        this.assets = new CombatantAssets(manager, Ferry, ICON, SIZE);
