 ...
 */
public class GiantTurtleFactory implements AssetProvider<Item>
{
    private static final GridPoint2 ICON = new GridPoint2(92, 190);
    ...
    public GiantTurtleFactory(AssetManager manager) {
        this.assets = new CombatantAssets(manager, GiantTurtle, ICON, SIZE);
