 ...
 */
public class DragonFactory implements AssetProvider<Item>
{
    private static final GridPoint2 ICON = new GridPoint2(46, 228);
    ...
    public DragonFactory(AssetManager manager) {
        this.assets = new CombatantAssets(manager, Dragon, ICON, SIZE);
