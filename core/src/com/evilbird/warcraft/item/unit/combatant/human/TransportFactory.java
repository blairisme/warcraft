 ...
 */
public class TransportFactory implements AssetProvider<Item>
{
    private static final GridPoint2 ICON = new GridPoint2(0, 152);
    ...
    public TransportFactory(AssetManager manager) {
        this.assets = new CombatantAssets(manager, Transport, ICON, SIZE);
