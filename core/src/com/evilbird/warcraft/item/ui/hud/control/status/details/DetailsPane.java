...
package com.evilbird.warcraft.item.ui.hud.control.status.details;
...
import com.evilbird.warcraft.item.ui.hud.control.status.details.building.BuildingDetailsPane;
import com.evilbird.warcraft.item.ui.hud.control.status.details.combatant.CombatantDetailsPane;
import com.evilbird.warcraft.item.ui.hud.control.status.details.combatant.CombatantTitlePane;
import com.evilbird.warcraft.item.ui.hud.control.status.details.common.UnitTitlePane;
import com.evilbird.warcraft.item.ui.hud.control.status.details.resource.ResourceDetailsPane;
