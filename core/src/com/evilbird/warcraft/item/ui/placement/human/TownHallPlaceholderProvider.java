 ...
 * represent a town hall before construction.
 *
 * @author Blair Butterworth
 */
public class TownHallPlaceholderProvider implements AssetProvider<Item>
{
    private static final String BUILDING_TEXTURE = "data/textures/human/winter/town_hall.png";
    ...
    @Inject
    public TownHallPlaceholderProvider(Device device, EventQueue events) {
        this.events = events;
    ...
    private PlaceholderStyle getStyle() {
        ...
        style.building = getDrawable(assets, BUILDING_TEXTURE, 0, 0, 128, 128);
        style.allowed = getDrawable(assets, ALLOWED_TEXTURE, 0, 0, 128, 128);
        style.prohibited = getDrawable(assets, PROHIBITED_TEXTURE, 0, 0, 128, 128);
        return style;
    }
}