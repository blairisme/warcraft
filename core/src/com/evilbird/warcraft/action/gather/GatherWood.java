...
import static com.evilbird.engine.action.predicates.ActionPredicates.whileSubject;
...
import static com.evilbird.warcraft.item.common.query.UnitPredicates.isGathering;
...
public class GatherWood extends ScenarioSetAction
{
    ...
    private void gatherFeature() {
        scenario("Gather Wood")
            ...
            .then(gather(progress(), GATHER_TIME), playRepeat(ChopWood, whileSubject(isGathering())))
