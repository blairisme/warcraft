 ...
 */
public class ConstructSequence extends DelegateAction
{
    ...
    @Inject
    public ConstructSequence(ItemFactory itemFactory) {
    ...
    private Action constructionProgress(CreateAction createAction) {
        ...
        Action constructing = new ConstructAction(true);
        Action idle = new ConstructAction(false);
