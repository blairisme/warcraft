...
import com.evilbird.warcraft.object.display.components.actions.buttons.ButtonControllers;
...
public class ActionPane extends Grid implements MenuProvider
{
    ...
    public ActionPane(Skin skin) {
        ...
        setCellWidth(54);
        setCellHeight(46);
        setIdentifier(UserInterfaceComponent.ActionPane);
        setType(UserInterfaceComponent.ActionPane);
