 ...
 */
public class MapTerrainLayer extends BaseRenderable implements Renderable, Disposable
{
    private Texture terrain;
    private GameObjectContainer container;
    private Collection<LayerType> terrains;

    public MapTerrainLayer(GameObjectContainer container, Collection<LayerType> terrains) {
