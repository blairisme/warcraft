...
/**
 * Controls the buttons shown when a demolition unit is selected.
 *
 * @author Blair Butterworth
 */
public class DemolitionButtons implements ButtonController
{
    @Override
    public List<ActionButtonType> getButtons(GameObject gameObject) {
        return asList(MoveButton, StopButton, DetonateButton);
    }
