...
package com.evilbird.warcraft.object.display.control.status;
...
{
    private com.evilbird.warcraft.object.display.control.status.details.DetailsPane detailsPane;
