...
{
    private static final List<com.evilbird.warcraft.object.display.control.actions.ActionButtonType> BUTTONS = singletonList(com.evilbird.warcraft.object.display.control.actions.ActionButtonType.GryphonRiderButton);
