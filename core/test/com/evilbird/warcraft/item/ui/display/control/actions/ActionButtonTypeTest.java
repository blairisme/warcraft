...
/**
 * Instances of this unit test validate the {@link com.evilbird.warcraft.item.display.control.actions.ActionButtonType} class.
 *
...
public class ActionButtonTypeTest
{
    ...
    public void getBuildProductTest() {
        ...
        for (com.evilbird.warcraft.item.display.control.actions.ActionButtonType button: com.evilbird.warcraft.item.display.control.actions.ActionButtonType.values()) {
    ...
    public void getUpgradeProductTest() {
        ...
        for (com.evilbird.warcraft.item.display.control.actions.ActionButtonType button: ActionButtonType.values()) {
