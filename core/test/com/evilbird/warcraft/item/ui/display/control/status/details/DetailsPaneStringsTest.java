...
import com.evilbird.warcraft.item.display.control.status.details.DetailsPaneStrings;
...
/**
 * Instances of this unit test validate the {@link com.evilbird.warcraft.item.display.control.status.details.DetailsPaneStrings} class.
 *
...
public class DetailsPaneStringsTest
{
    ...
    private com.evilbird.warcraft.item.display.control.status.details.DetailsPaneStrings strings;
