...
/**
 * Instances of this unit test validate logic in the {@link BallistaFactory} class.
 *
...
public class BallistaFactoryTest extends CombatantFactoryTestCase<BallistaFactory>
{
    ...
    @Override
    protected BallistaFactory newFactory(DeviceDisplay display, AssetManager assets) {
        return new BallistaFactory(assets);
    }
