 ...
 */
public class OgreMageFactoryTest extends CombatantFactoryTestCase<OgreMageFactory>
{
    @Override
    ...
    @Override
    protected OgreMageFactory newFactory(DeviceDisplay display, AssetManager assets) {
        return new OgreMageFactory(assets);
    }
