...
/**
 * Instances of this unit test validate the {@link HumanCampaign4} class.
 *
 * @author Blair Butterworth
 */
public class HumanCampaign4Test extends HumanCampaignTestCase
{
    @Override
    public OperationOrder getCampaign() {
        return new HumanCampaign4();
    }
}