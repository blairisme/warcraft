...
/**
 * Instances of this unit test validate the {@link com.evilbird.warcraft.behaviour.ui.objective.condition.PlayerOwnership} class.
 *
...
public class PlayerOwnershipTest extends GameTestCase
{
    ...
    public void applicableConstructTest() {
        ...
        com.evilbird.warcraft.behaviour.ui.objective.condition.PlayerOwnership condition = com.evilbird.warcraft.behaviour.ui.objective.condition.PlayerOwnership.playerOwns(Footman, 2);
    ...
    public void applicableProduceTest() {
        ...
        EventQueue queue = new EventQueue();
        queue.add(new ProduceEvent(building, Footman, ProduceStatus.Started));
        Assert.assertFalse(condition.applicable(queue));

        queue.update();
        queue.add(new ProduceEvent(building, Footman, ProduceStatus.Complete));
        Assert.assertTrue(condition.applicable(queue));
    }
    ...
    public void evaluateFalseTest() {
        com.evilbird.warcraft.behaviour.ui.objective.condition.PlayerOwnership condition = PlayerOwnership.playerOwns(TownHall, 1);
        condition.initialize(root);
