...
import com.evilbird.warcraft.object.effect.confirmation.ConfirmEffectFactory;
...
/**
 * Instances of this unit test validate logic in the {@link EffectFactory}
 * class.
 *
 * @author Blair Butterworth
 */
public class ConfirmEffectFactoryTest extends GameFactoryTestCase<ConfirmEffectFactory> {

    @Override
    protected ConfirmEffectFactory newFactory(DeviceDisplay display, AssetManager assets) {
        return new ConfirmEffectFactory(assets);
    }
    ...
    protected Collection<Identifier> getProductIdentifiers() {
        return Arrays.asList(EffectType.values());
    }
